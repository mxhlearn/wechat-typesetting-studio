...
把微信公众号草稿、笔记、教程、评论、解释、清单、案例、访谈和选题整理成适合 WeMD 的 Markdown。
...
- 根据用户反馈更新写作约束和审稿标准
- 输出适合 WeMD 预览和复制到公众号的干净 Markdown
...
使用 $wechat-article-pre，审一下这篇教程，保留操作步骤，去掉水话，并补一个 2.35:1 封面 brief。
```
...
```powershell
python <codex-home>\skills\.system\skill-creator\scripts\quick_validate.py skills\wechat-article-pre
```
